...
authRoutes.post("/change-password", authenticate([UserRole.SuperAdmin,UserRole.Admin,UserRole.Emp,UserRole.Supervisor,UserRole.SupervisorAdmin]),changePasswordHandler); 
