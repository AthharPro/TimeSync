...
import {createHandler, listHandler, listMyProjectsHandler, updateStaffHandler, updateDetailsHandler, deleteHandler, activateHandler, listSupervisedProjectsHandler} from "../controllers/project.controller";
...
projectRoutes.put("/:id", authenticate([UserRole.Admin, UserRole.SupervisorAdmin, UserRole.SuperAdmin]), updateDetailsHandler);
